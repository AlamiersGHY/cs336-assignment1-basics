...
import numpy as np
import wandb
from cs336_basics.reference.nn import TransformerLM
from cs336_basics.reference.optimizer import AdamW, clip_gradient_norm
from cs336_basics.reference.scheduler import get_lr_cosine_schedule
from cs336_basics.reference.data import get_batch
from cs336_basics.reference.checkpointing import save_checkpoint, load_checkpoint
from cs336_basics.reference.losses import cross_entropy
...
def main():
    ...
    start_iter=0
    ckpt_path=os.path.join(args.out_dir,"chpt.pt")
