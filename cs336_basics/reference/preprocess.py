...
from cs336_basics.reference.tokenizer import BPETokenizer
...
def main():
    # Configuration
    BAES_DIR="./data/TinTinyStoriesV2-GPT4-train"
    input_file="./data/TinyStoriesV2-GPT4-train.txt"  #待处理语料
    output_file="./data/TinyStoriesV2-GPT4-train.bin"  #输出的二进制文件
    
    vocab_json=os.path.join(BAES_DIR,"vocab.json")
    merges_txt=os.path.join(BAES_DIR,"merges.txt")
